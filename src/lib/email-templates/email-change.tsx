...
export const EmailChangeEmail = (props: Props) => {
  const { newEmail, confirmationUrl } = props
  return (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Confirma tu nuevo email</Preview>
    <Body style={main}>
      <Section style={wrapper}>
        <Container style={container}>
          ...
          <Section style={body}>
            ...
            <Text style={text}>Recibimos una solicitud para cambiar el email de tu cuenta. Confirma haciendo click en el botón.</Text>
            
            <Section style={{ textAlign: 'center', margin: '8px 0 24px' }}>
              <Button style={button} href={confirmationUrl}>Confirmar nuevo email</Button>
            </Section>
            <Text style={footer}>Si no solicitaste este cambio, ignora este correo.</Text>
          </Section>
        </Container>
      </Section>
    </Body>
