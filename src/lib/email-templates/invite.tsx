...
export const InviteEmail = (props: Props) => {
  const { siteName, confirmationUrl } = props
  return (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Has sido invitado a Terraza Gourmet</Preview>
    <Body style={main}>
      <Section style={wrapper}>
        <Container style={container}>
          ...
          <Section style={body}>
            <Heading style={h1}>Te invitamos a Terraza Gourmet</Heading>
            <Text style={text}>Has sido invitado a unirte a Terraza Gourmet City Market. Acepta la invitación para crear tu cuenta.</Text>
            
            <Section style={{ textAlign: 'center', margin: '8px 0 24px' }}>
              <Button style={button} href={confirmationUrl}>Aceptar invitación</Button>
            </Section>
            <Text style={footer}>Si no esperabas esta invitación, puedes ignorarla.</Text>
          </Section>
        </Container>
      </Section>
    </Body>
