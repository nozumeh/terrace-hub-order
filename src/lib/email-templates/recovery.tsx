...
export const RecoveryEmail = (props: Props) => {
  const { confirmationUrl } = props
  return (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Restablece tu contraseña de Terraza Gourmet</Preview>
    <Body style={main}>
      <Section style={wrapper}>
        <Container style={container}>
          ...
          <Section style={body}>
            ...
            <Text style={text}>Recibimos una solicitud para restablecer tu contraseña. Haz click en el botón a continuación para crear una nueva. El enlace expira en 1 hora.</Text>
            
            <Section style={{ textAlign: 'center', margin: '8px 0 24px' }}>
              <Button style={button} href={confirmationUrl}>Crear nueva contraseña</Button>
            </Section>
            <Text style={footer}>Si no solicitaste este cambio, ignora este correo. Tu contraseña no será modificada.</Text>
          </Section>
        </Container>
      </Section>
    </Body>
